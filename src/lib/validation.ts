...
export const createAgentSchema = z.object({
  ...
  hermes_id: z.string().regex(/^[a-z0-9][a-z0-9-]*$/, 'hermes_id must be kebab-case').max(100).optional(),
  ...
  provision_hermes_workspace: z.boolean().optional(),
  hermes_workspace_path: z.string().min(1).max(500).optional(),
  runtime_type: z.enum(['hermes', 'hermes', 'claude', 'codex', 'custom']).optional(),
})
