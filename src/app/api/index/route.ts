...
const endpoints: Endpoint[] = [
  ...
  { path: '/api/hermes/version', methods: ['GET'], description: 'Installed Hermes version and latest release metadata', tag: 'System', auth: 'public' },
  { path: '/api/hermes/update', methods: ['POST'], description: 'Update Hermes to the latest stable release', tag: 'System', auth: 'admin' },
  { path: '/api/hermes/doctor', methods: ['GET', 'POST'], description: 'Inspect and fix Hermes configuration drift', tag: 'System', auth: 'admin' },
