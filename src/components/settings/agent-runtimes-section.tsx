...
export function AgentRuntimesSection({ showFeedback }: Props) {
  ...
  const [setupRuntime, setSetupRuntime] = useState<'hermes' | 'hermes' | 'claude' | 'codex' | 'opencode' | null>(null)
              ...
              <div className="relative p-3">
                {isInstalling ? (
                  ...
                  <>
                    ...
                    {(rt.installed || justInstalled) && (
                      <button
                        onClick={() => setSetupRuntime(rt.id as 'hermes' | 'hermes' | 'claude' | 'codex' | 'opencode')}
